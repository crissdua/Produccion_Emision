...
#End Region
    ...
    Private Sub generaEntrada(docE As String)
        ...
        Try
            ...
            Dim frm As New Produccion_Emision.Batchs
            ...
            ElseIf result = DialogResult.Yes Then
                ...
                For Each row As DataGridViewRow In DGV2.Rows
                    ...
                    If chk.Value IsNot Nothing AndAlso chk.Value = True Then
                        ...
                        oInvGenExit.Lines.AccountCode = "_SYS00000001408"
                        ...
                        For cont = 0 To ba.Count - 1
                            ...
                            oInvGenExit.Lines.BatchNumbers.Quantity = Decimal.Round((quantity.Item(cont)), 3, MidpointRounding.AwayFromZero)
